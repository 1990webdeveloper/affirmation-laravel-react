        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                <div class="-intro-x flex items-center pt-5">
                    <img alt="logo" class="w-1/3 filter invert-1" src="{{ asset('dist/images/logo-white.png') }}">

                </div>
                <div class="my-auto">
                    <img alt="logo" class="-intro-x w-1/2 -mt-16" src="{{ asset('dist/images/illustration.svg') }}">
